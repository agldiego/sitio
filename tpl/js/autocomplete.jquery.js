        ...
        $(this).each(function(){                               
            ...
            $(this).find('input').bind('keyup',function(event){
                ...
                else if((code>47 && code<91)||(code>96 && code<123) || code ==8 )
                {
                    ...
                    // tomo la url                    
                    var urls = input.attr('data-source');     
                    campo    = input.attr('campo');
...
//                     }
//                     
//                     alert("La url es la siguiente "+urls);
//                    $.ajax({
//                       async:true,
//                       type: "GET",
//                       dataType: "html",
...
//                     }); 
                    ...
                    $.getJSON(urls,{}, function(data){                                        
                        ...
                        for(index in data)
                        {   
                           //alert(data[index].desc);
                            //agrego un link por resultado
                            if(data.hasOwnProperty(index))
                                {
                                     
                                    var a = $('<a>');
                                    a.html(data[index].desc);
                                    a.attr('codigo',data[index].codigo);
                                    
                                    if(tipo){
                                        a.addClass('autocomplete-jquery-item2');
                                    } else {
